...
export const PERSONAL_INFO = {
  ...
  subTitle:
    "Computer Science & Engineering undergrad passionate about algorithmic problem-solving Building and Learning new Technologies.",
  about: `I am Subham Sahoo S, a student pursuing a Bachelor of Engineering in Computer Science and Engineering at Chennai Institute of Technology, with a strong aspiration to build a high-impact career in the tech industry, specifically in a software development engineering role.

With a strong academic background maintaining a deep passion for technology, and a relentless commitment to continuous learning, I have developed an advanced understanding of programming fundamentals and core algorithmic problem-solving skills, demonstrated by solving problems on Various Platforms like LeetCode, Codechef, Codeforce .

I possess excellent communication and collaborative skills, having led technical engineering teams to first-place victories in prominent national hackathons and actively participating in intensive competitive environments. These experiences have sharpened my confidence, leadership, and adaptive abilities, helping me collaborate effectively with cross-functional teams to build production-ready applications. I am multilingual—fluent in English, Tamil, Hindi, and Odia—which enables me to work and connect efficiently in diverse, global environments.

I believe in maintaining a balanced approach between rigorous technical expertise and strong interpersonal skills, which I consider vital for engineering meaningful, scalable solutions in today’s dynamic IT world.
...
Let's connect and grow together!`,
  education: {
    ...
    highlights: [
      ...
      "Member of the AI/ML , Web Development and Open Source Club",
      "Consistent top performer in academic and practical engineering challenges",
    ],
  },
  socials: {
    linkedin: "https://www.linkedin.com/in/subhamsahoos",
    github: "https://github.com/subhamsahoo2024/",
    email: "mailto:subhamsahoo23415@gmail.com",
  },
};
...
export const PROJECTS: Project[] = [
  {
    ...
    title: "GuardianLink",
    description:
      "A low-latency, cross-platform emergency response Progressive Web App (PWA) providing real-time AI hazard triage and dynamic indoor/outdoor geospatial evacuation pathfinding during active crises.",
    tags: [
      "Next.js",
      "Firebase",
      "LLaMa 4",
    ...
    github: "https://github.com/subhamsahoo2024/GuardianLink",
    demo: "https://guardian-link-five.vercel.app/",
    features: [
  ...
  },
  {
    ...
    title: "NavX",
    description:
      "An intelligent, map-digitizing navigation system that converts physical layout schematics into interactive multi-floor pathfinding graphs with localized natural language support.",
    tags: [
      "Next.js",
      "MongoDB",
      "Gemini API",
    ...
    categories: ["AI", "Full-Stack"],
    github: "https://github.com/subhamsahoo2024/NavX-indoor-nav",
    demo: "https://cit-maps.vercel.app/",
    features: [
  ...
  },
  {
    ...
    title: "Smart Heart",
    description:
      "A high-throughput clinical analytical engine combining ECG and PCG deep learning architectures for automated cardiovascular risk forecasting and explainable visual medical triage.",
    tags: [
      "Python",
      "FastAPI",
      "Next.js",
    ...
    categories: ["AI"],
    github: "https://github.com/subhamsahoo2024/SmartHeart",
    demo: "",
    features: [
  ...
  },
  {
    ...
    title: "Intervion AI",
    description:
      "An adaptive, industrial-grade career assessment simulator leveraging local large language models to construct real-time resume parsing, runtime coding execution sandboxes, and behavioral analysis.",
    tags: [
      "React",
      "TypeScript",
      "Python",
    ...
    categories: ["AI", "Full-Stack"],
    github: "https://github.com/subhamsahoo2024/Intervion-ai",
    demo: "https://intervion-ai-sst.vercel.app/login",
    features: [
  ...
  },
  {
    ...
    title: "INNOVEX",
    description:
      "An AI-driven, gamified enterprise accelerator platform for universities designed to orchestrate semantic mentor-investor matchmaking, real-time ecosystem telemetry, and agile startup tracking.",
    tags: [
      "Next.js",
      "Supabase",
      "pgvector",
    ...
    categories: ["AI", "Full-Stack"],
    github: "https://github.com/subhamsahoo2024/campus-connect-sdg",
    demo: "https://campus-connect-murex-eight.vercel.app/",
    features: [
  ...
  },
  {
    ...
    title: "BlockTrackEd",
    description:
      "A multi-portal Web3 decentralized application (dApp) leveraging immutable smart contracts to eliminate financial intermediaries and secure transparent scholarship allocation workflows.",
    tags: [
      "Solidity",
      "Ethers.js",
      "MetaMask",
    ...
    categories: ["Full-Stack", "Web3"],
    github: "https://github.com/subhamsahoo2024/BlockTrackEd",
    demo: "",
    features: [
  ...
  },
  {
    ...
    title: "Think-book",
    description:
      "A modular, high-performance React note management application featuring full-text lookahead indexing, offline-first persistence architectures, and secure tokenized authentication loops.",
    tags: [
      "React",
      "TypeScript",
    ...
    github: "https://github.com/subhamsahoo2024/Think-Book",
    demo: "",
    features: [
  ...
  },
  {
    ...
    description:
      "A micro-architected Node.js/Express server optimized for high-speed delivery of raw browser-native client assets and low-overhead browser application deployment.",
    tags: [
      "Node.js",
      "Express.js",
      "Static File Hosting",
    ...
    categories: ["Full-Stack"],
    github: "https://github.com/subhamsahoo2024/Mini-game-website",
    demo: "",
    features: [
...
export const SOFT_SKILLS: SoftSkill[] = [
  {
    ...
    description:
      "You have won major multi-day hackathons (HackBells 3.0, GDG TechSprint). This proves you can lead technical direction, divide development tasks under extreme time constraints, and ship working code under high pressure.",
  },
  {
    id: "soft2",
    ...
    description:
      "Consistency is hard. Solving 900+ highly complex data structure problems requires intense mental stamina, structural debugging capabilities, and deep optimization focus.",
  },
  {
    id: "soft3",
    ...
    description:
      "Your project portfolio transitions smoothly from blockchain decentralization (BlockTrackEd) to Deep Learning audio tensors (Smart Heart) to advanced AI vector search. You possess the ability to rapidly learn an entirely new framework or API and implement it within weeks.",
  },
  {
    id: "soft4",
    ...
    description:
      "Your internships required collaborating directly with backend developers, product owners, and clients to translate loose requirements into pixel-perfect, production-ready REST integrations.",
  },
];
