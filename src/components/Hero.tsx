...
export default function Hero({ theme, onOpenCVModal }: HeroProps) {
  ...
  const profileImgUrl = "/images/profile%20photo.jpeg";
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full blur-[120px] -z-10 animate-pulse duration-5000 transition-colors ${
          theme === "dark" ? "bg-indigo-600/10" : "bg-indigo-600/5"
        }`}
      ></div>
      <div
        className={`absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full blur-[100px] -z-10 animate-pulse duration-7000 transition-colors ${
      ...
      <div
        className={`absolute inset-0 bg-[linear-gradient(to_right,var(--grid-color)_1px,transparent_1px),linear-gradient(to_bottom,var(--grid-color)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)] -z-15`}
        style={
          {
            "--grid-color": theme === "dark" ? "#1f29370a" : "#64748b0a",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        >
          ...
          >
            Hi, I'm{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-indigo-400 to-emerald-500 font-extrabold">
              {PERSONAL_INFO.name}
            </span>
            <span
              className={`block mt-2 text-2xl sm:text-3xl lg:text-4xl font-normal transition-colors ${
          ...
          >
            ...
            >
              <FileText
                size={18}
                className="text-indigo-200 group-hover:scale-105 transition-transform"
              />
        ...
        >
          <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 flex items-center justify-center">
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-[linear-gradient(to_right,var(--grid-inner)_1px,transparent_1px),linear-gradient(to_bottom,var(--grid-inner)_1px,transparent_1px)] bg-[size:1rem_1rem] opacity-60`}
                style={
                  {
                    "--grid-inner":
                      theme === "dark" ? "#312e811f" : "#6366f10d",
                  } as React.CSSProperties
                }
              ></div>
              ...
              {!imgError ? (
                ...
                <>
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <stop
                          offset="100%"
                          stopColor={theme === "dark" ? "#0f172a" : "#e2e8f0"}
                        />
                      </linearGradient>
                    </defs>
                  </svg>
                  ...
                  <div className="absolute inset-0 bg-slate-950/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center text-center p-4">
                    <span className="text-white text-xs font-mono font-bold uppercase tracking-wider mb-1">
                      Set Photo
                    </span>
                    <span className="text-slate-300 text-[10px] font-mono leading-tight max-w-[140px]">
                      Place your headshot as profile.jpg in public/ folder
                    </span>
                  </div>
                </>
              )}
              ...
              <div
                className={`absolute inset-0 flex flex-col justify-between p-6 opacity-20 pointer-events-none font-mono text-[9px] select-none ${
      ...
      <div
        className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 cursor-pointer opacity-70 hover:opacity-100 transition-opacity"
