  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-96 h-32 rounded-full blur-[70px] -z-10 pointer-events-none transition-colors ${
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-xs text-slate-500 font-mono mt-1">
              Building Scalable Full-Stack AI Solutions • 2026 Developer
              Portfolio
            </p>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div
              className={`w-[1px] h-4 ${theme === "dark" ? "bg-white/10" : "bg-slate-200"}`}
            ></div>
